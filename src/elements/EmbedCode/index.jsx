  ...
  return (
    <div className={styles.embedsContainer}>
      ...
      <div className={styles.codeBlock}>
        {`
<div id="${projectSlug}-embed-${illoSlug}" data-frame-src="${embedRoot}" data-frame-sandbox="allow-scripts allow-same-origin allow-top-navigation" style="min-width: 310px;"></div>
